...
<div class="container my-5">
    <h1 class="mb-4 text-success"><i class="bi bi-shield-lock me-2"></i>Privacy Policy</h1>
    ...
    <div class="mt-4">
        <a href="../../index.php" class="btn btn-secondary"><i class="bi bi-arrow-left"></i> Back to Home</a>
    </div>
</div>
