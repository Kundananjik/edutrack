 ...
 * Purpose: Receives POST from student dashboard to mark attendance via QR only.
...
try {
    if (!$qr || $session_code === '') {
        throw new Exception('Manual attendance entry is disabled. Please scan the lecturer QR code.');
    }
